...
namespace TMS.Controllers
{
    ...
    public class CityController : Controller
    {
        ...
        public CityController(TMSContext context)
        {
        ...
        public JsonResult Search(string param)
        {
            ...
            try
            {
                var code = context.Cities.Where(a => a.Name.ToLower().Contains(param.ToLower()))
                    .Select(a => new
                    {
                        a.Id,
                        a.Name,
        ...
        public JsonResult Recall(int id)
        {
            ...
            try
            {
                var code = context.Cities.Where(a => a.Id == id)
                    .Select(a => new
                    {
                        a.Id,
                        a.Name,
        ...
        public JsonResult Edit(IFormCollection vm)
        {
            ...
            try
            {
                City data = context.Cities.Where(a => a.Id == id).FirstOrDefault();
                data.Name = name;
        ...
        public JsonResult Exists(string name)
        {
            ...
            try
            {
                var data = context.Cities.Where(a => a.Name == name).FirstOrDefault();
                if (data == null)
                {
                    json.Value = "Success";
                    json.StatusCode = 200;

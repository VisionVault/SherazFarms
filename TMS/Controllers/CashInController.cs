...
namespace TMS.Controllers
{
    ...
    public class CashInController : Controller
    {
        ...
        private readonly DocType CRVDT;

        public CashInController(TMSContext context, UserManager<User> usrMgr)
        {
            this.context = context;
            this.usrMgr = usrMgr;
            CRVDT = context.DocTypes.Where(a => a.Name == "CRV").FirstOrDefault();
        }
        ...
        public JsonResult GetMaxDocId()
        {
            ...
            try
            {
                ...
                var data = context.LedgerDetails.Where(a => a.TradeFirmId == tf.Id && a.DocTypeId == CRVDT.Id).OrderByDescending(a => a.DocId).FirstOrDefault();
        ...
        public JsonResult GetAll(IFormCollection vm)
        {
            ...
            try
            {
                ...
                && a.DocTypeId == CRVDT.Id && a.TransactionStatusId != 3 && a.Credit > 0)
                    .Select(a => new
                    {
                        a.DocId,
                        a.TransactionDate,
        ...
        public JsonResult Recall(long id)
        {
            ...
            {
                var tf = SysAcc.GetTF(context, usrMgr.GetUserId(User));
                var data = context.LedgerDetails.Where(a => a.TradeFirmId == tf.Id && a.DocId == id && a.DocTypeId == CRVDT.Id && a.TransactionStatusId != 3 && a.Credit > 0)
                    .Select(a => new
                    {
                        a.DocId,
                        a.TransactionDate,
        ...
        public JsonResult Remove(long id)
        {
            ...
            {
                var tf = SysAcc.GetTF(context, usrMgr.GetUserId(User));
                var data = context.LedgerDetails.Where(a => a.TradeFirmId == tf.Id && a.DocId == id && a.DocTypeId == CRVDT.Id && a.TransactionStatusId != 3).ToList();
                if (data.Count > 0)
                {
        ...
        public JsonResult Delete(long docId)
        {
            ...
            {
                var tf = SysAcc.GetTF(context, usrMgr.GetUserId(User));
                var data = context.LedgerDetails.Where(a => a.TradeFirmId == tf.Id && a.DocId == docId && a.DocTypeId == CRVDT.Id && a.TransactionStatusId != 3).ToList();
                if (data.Count > 0)
                {
